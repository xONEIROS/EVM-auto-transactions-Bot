...
def send_transactions(w3, from_account, to_addresses, amount, chain_id, delay, block_explorer):
...
def main():
    ...
    try:
        send_transactions(w3, from_account, to_addresses, amount, chain_id, delay, block_explorer)
